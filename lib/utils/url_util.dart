...
//  static String ROOT = "http://mp.qweib.com/";
  ...
  static String menu_list = "/web/menus";//菜单
  static String upload_pic_single = "/web/upload/single";//上传单张图片
  static String del_pic_single = "/web/upload/remove";//删除单张图片
  static String WARE_SAVE =  "/web/basic/bas_ware/save_update";//保存商品
